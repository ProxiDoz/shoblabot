...
# Для созвона
sozvon_options = ['Го сегодня вечером', 'Го в пятницу вечером', 'Го в субботу пораньше', 'Го в субботу попозже', 'Го в воскресенье пораньше', 'Го в воскресенье попозже']
sozvon_link = 'https://meet.google.com/tnj-dfkq-bpk'
sozvon_pic = 's'
