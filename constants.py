...
#            '6) 🎧 перехода в собственный плейлист - /music\n' \
#            '7) 💁‍♀️🚗 Встроенная девка за рулём\n' \
#            '8) 👩🏻‍⚕️ Встроенный вызов врачаааа'.format(chat_name)
...
help_text = '🤖 *Shobla Bot* используется для:\n\n' \
		...
		'3) ✅ сохраниение гос.номера зеленого Rapida - /rapid\n' \
            ...
            '5) 👩🏻‍⚕️ Встроенный вызов врачаааа'.format(chat_name)
