...
def send_error(message, error_id, error_text):
    try:
        ...
        bot.send_message(secret.apple_id, '❌ Ошибка в функции send_error:\n*Сообщение: *{0}\n*Текст ошибки:*\n{1}'.format(message.text, send_error_error), parse_mode='MarkdownV2')
